...
export const ProjectCard = ({ name, description, link }: Project) => {
    ...
    return (
        <div
            className='card mb-10 cursor-pointer border border-white rounded-[10px] h-fit md:w-[40%] ml-6 mr-6 md:ml-0 md:mr-0 hover:shadow-lg transition-shadow duration-300 ease-in-out'>
