export const UsersIcon = ({ width = 24, height = 24 }) => (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M3 19C3.69137 16.6928 5.46998 16 9.5 16C13.53 16 15.3086 16.6928 16 19" stroke="#FFFFFF"
              strokeWidth="2" strokeLinecap="round" />
        <path d="M17 15C19.403 15.095 20.5292 15.6383 21 17" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round" />
        <path
