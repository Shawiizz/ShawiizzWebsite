...
export default function ThemeSwitcher({className}: { className?: string}) {
    ...
    return (
        <button onClick={themeButtonClickListener} type="button" aria-label="Toggle theme"
                className={`text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 ${className}`}>
